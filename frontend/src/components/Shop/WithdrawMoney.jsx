...
const WithdrawMoney = () => {
  ...
  const error = () => {
    toast.error("You not have enough money to withdraw!");
  };

  const withdrawHandler = async () => {
    if(withdrawAmount < 20 || withdrawAmount > seller?.availableBalance ){
      toast.error("You cant't withdraw this amount!")
    }else{
    ...
    await axios
      ...
      .then((res) => {
        toast.success("Withdraw request is successfull!");
      });
    }
  };
        ...
        <div className="w-full h-screen z-[9999] fixed top-0 left-0 flex items-center justify-center bg-[#0000004e]">
          <div
            className={`w-[95%] 800px:w-[50%] bg-white shadow rounded ${
              paymentMethod ? "h-[80vh] overflow-auto" : "h-[unset]"
            } min-h-[40vh] p-3`}
          >
            ...
            {paymentMethod ? (
              <div>
                <h3 className="text-[21px] font-Poppins text-center font-[600]">
              ...
              <>
                <h3 className="text-[21px] font-Poppins">
                ...
                {seller && seller?.withdrawMethod ? (
                  ...
                  <div>
                    <p className="text-[18px] pt-1">
                      No Withdraw Method is Availabe
                    </p>
