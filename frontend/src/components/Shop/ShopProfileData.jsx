    ...
    <>
      {isLoading ? (
        ...
        <div className="w-full">
          ...
          {active === 1 && (
            <div className="grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] xl:grid-cols-4 xl:gap-[20px] md-12 border-0">
              {products &&
              ...
              allReviews && allReviews.map((item, index ) => (
                <div className="w-full flex my-4">
                  ...
                  <div className="pl-2">
                    ...
                    <p className="text-[#000000a7] text-[14px]">{'1 day ago'}</p>
                  </div>
                </div>
              ))
            }
