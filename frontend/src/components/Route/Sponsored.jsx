  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img // will be change
            src="https://tse3.mm.bing.net/th?id=OIP.Ilw-NM1ai6FGPEEFSDhIQgAAAA&pid=Api&P=0&h=220"
            alt=""
            style={{ width: "150px", objectFit: "contain" }}
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://tse3.mm.bing.net/th?id=OIP.hYh5aYM5aSIjABohEs_QuAHaDt&pid=Api&P=0&h=220"
            alt=""
            style={{ width: "150px", objectFit: "contain" }}
          />
        </div>
