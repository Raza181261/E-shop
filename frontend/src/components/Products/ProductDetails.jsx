...
const ProductDetails = ({ data }) => {
  ...
  const [select, setSelect] = useState(0); // Initialize with a valid index
  ...
  const handleMessageSubmit = async() => {
    if(isAuthenticated){
      ...
      toast.error("Please login to create conversation with seller")
    }
  };
            ...
            <div className="block w-full 800px:flex">
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="flex items-center pt-8">
                  ...
                  <div
                    className={`${styles.button} bg-[#6434d1] mt-4 !rounded !h-11`}
...
const ProductDetailsInfo = ({ data, products, totalReviewsLength, averageRating }) => {
  ...
  return (
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded ">
      ...
      {active === 2 ? (
        <div className="w-full  min-h-[40vh] flex flex-col items-center py-3 overflow-auto">
          {data &&
          ...
          <div className="w-full flex justify-center">
            {data && data.reviews.length === 0 && (
              <h5>No Reviews have this product</h5>
            )}
          </div>
        </div>
      ) : null}
        ...
        <div className="w-full block 800px:flex p-5">
          ...
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
            <div className="text-left">
              ...
              <h5 className="font-[600]">
                Total Products:<span className="font-[500]"> {data.shop}</span>
              </h5>
              <h5 className="font-[600]">
                Total Reviews:<span className="font-[500]"> 487</span>
              </h5>
              <Link to="/">
                <div
